...
public class HomeFragment extends Fragment implements View.OnClickListener{
    ...
    public void onClick(View v) {
        Intent intent;
        switch (v.getId()){
            case R.id.card1: intent=new Intent(getActivity(),TDP.class);startActivity(intent);break;
            case R.id.card2: intent=new Intent(getActivity(),TDP.class);startActivity(intent);break;
            case R.id.card3: intent=new Intent(getActivity(),TDP.class);startActivity(intent);break;
            case R.id.card4: intent=new Intent(getActivity(),TDP.class);startActivity(intent);break;
            case R.id.card5: intent=new Intent(getActivity(), TDP.class);startActivity(intent);break;
            case R.id.card6: intent=new Intent(getActivity(), TDP.class);startActivity(intent);break;
            default:break;
        }
